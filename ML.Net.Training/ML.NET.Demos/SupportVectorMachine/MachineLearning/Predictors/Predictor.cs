...
namespace SupportVectorMachineClassification.MachineLearning.Predictors
{
    public class Predictor
    {
        protected static string ModelPath => Path.Combine(AppContext.BaseDirectory, "SvmClassificationModel.mdl");
